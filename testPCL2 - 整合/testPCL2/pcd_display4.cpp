#ifndef PCD_DISPALY4_H
#define PCD_DISPLAY4_H
...
void pcd_display4(char file1[30], char file2[30])
{
	...
	viewer_final->setPointCloudRenderingProperties(pcl::visualization::PCL_VISUALIZER_POINT_SIZE, 6, "target cloud");
	//对转换后的目标点云着色（绿色）并可视化
