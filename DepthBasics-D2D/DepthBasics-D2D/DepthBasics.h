...
private:
	...
	//HRESULT                 SaveToFile(cv::Mat Input, int nWidth, int  nHeight);
	HRESULT                 SaveBitmapToFile(CHAR* pBitmapBits, LONG lWidth, LONG lHeight, WORD wBitsPerPixel, LPCWSTR lpszFilePath);
};
